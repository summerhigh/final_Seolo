		...
		<div class="navbar-collapse offcanvas-collapse" id="Main">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="dropdown01" data-toggle="dropdown" aria-expanded="false">&nbsp;&nbsp;체크리스트</a>
					<div class="dropdown-menu" aria-labelledby="dropdown01">
						<a class="dropdown-item" href="<%=cp%>/MyChecklists.jsp">나의 체크리스트</a> <a class="dropdown-item" href="<%=cp%>/searchRegion_gu.jsp">지역 정보</a>
					</div></li>

				<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="dropdown01" data-toggle="dropdown" aria-expanded="false">&nbsp;&nbsp;공동구매</a>
					<div class="dropdown-menu" aria-labelledby="dropdown01">
						<a class="dropdown-item" href="#">나의 공동구매</a> <a class="dropdown-item" href="#">공동구매 모집</a>
					</div></li>
			</ul>
