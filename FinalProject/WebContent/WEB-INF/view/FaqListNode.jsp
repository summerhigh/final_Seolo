				...
				<div class="card-header" id="heading${list.faq_no }">
					<h2 class="mb-0">
						<button class="btn btn-link btn-block text-left collapsed"
							type="button" data-toggle="collapse" data-target="#collapse${list.faq_no }"
							aria-expanded="false" aria-controls="collapse${list.faq_no }">
							[${list.faqsort_name }]&nbsp;&nbsp;${list.faq_title }</button>
					</h2>
				</div>
				<div id="collapse${list.faq_no }" class="collapse" aria-labelledby="heading${list.faq_no }"
